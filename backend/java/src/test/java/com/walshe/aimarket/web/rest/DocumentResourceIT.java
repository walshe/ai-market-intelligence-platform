...
class DocumentResourceIT {
    ...
    public static Document createEntity() {
        return new Document().title(DEFAULT_TITLE).content(DEFAULT_CONTENT);
    }
    ...
    public static Document createUpdatedEntity() {
        return new Document().title(UPDATED_TITLE).content(UPDATED_CONTENT);
    }
    ...
    void putExistingDocument() throws Exception {
        ...
        updatedDocument.title(UPDATED_TITLE).content(UPDATED_CONTENT);
    ...
    void partialUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.title(UPDATED_TITLE);
